...
# Usage: bash dev/last30days/scripts/compare.sh "Kanye West"
#
...
if [ $# -eq 0 ]; then
  echo "Usage: bash dev/last30days/scripts/compare.sh <topic>"
  echo "  Example: bash dev/last30days/scripts/compare.sh Kevin Rose"
  exit 1
fi
TOPIC="$*"
