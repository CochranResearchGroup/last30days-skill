...
def get_config() -> dict[str, Any]:
    ...
    keys = [
        ...
        ('LAST30DAYS_SERVICE_SOURCES', None),
        ('LAST30DAYS_X_ACCESS_ORDER', None),
        ('LAST30DAYS_FACEBOOK_ACCESS_ORDER', None),
        ('LAST30DAYS_LINKEDIN_ACCESS_ORDER', None),
        ('LAST30DAYS_REDDIT_ACCESS_ORDER', None),
        ('LAST30DAYS_YOUTUBE_ACCESS_ORDER', None),
        ('LAST30DAYS_AGENT_BROWSER_JOB_TIMEOUT_MS', None),
        ('LAST30DAYS_AGENT_BROWSER_DISPLAY_ISOLATION', None),
        ('LAST30DAYS_AGENT_BROWSER_ALLOW_DUPLICATE_PROFILE_LANE', None),
        ...
        ('LAST30DAYS_REDDIT_BROWSER', None),
        ('LAST30DAYS_REDDIT_BROWSER_PROFILE', None),
        ('LAST30DAYS_REDDIT_BROWSER_SESSION', None),
        ('LAST30DAYS_REDDIT_BROWSER_BUILD', None),
        ('LAST30DAYS_REDDIT_BROWSER_VIEW_PROVIDER', None),
        ('LAST30DAYS_REDDIT_BROWSER_ID', None),
        ('LAST30DAYS_REDDIT_ROUTE_ID', None),
        ('LAST30DAYS_REDDIT_ROUTE_POOL_ENTRY_ID', None),
        ('LAST30DAYS_REDDIT_BROWSER_TIMEOUT', None),
        ('LAST30DAYS_REDDIT_BROWSER_MAX_RESULTS', None),
        ('LAST30DAYS_REDDIT_BROWSER_SCROLLS', None),
        ('LAST30DAYS_REDDIT_BROWSER_INITIAL_WAIT', None),
        ('LAST30DAYS_REDDIT_BROWSER_SCROLL_WAIT', None),
        ('AUTH_TOKEN', None),
        ('CT0', None),
        ('BSKY_HANDLE', None),
        ...
        ('LAST30DAYS_FACEBOOK_BROWSER_BUILD', None),
        ...
        ('LAST30DAYS_FACEBOOK_BROWSER_ID', None),
        ('LAST30DAYS_FACEBOOK_DISPLAY_ALLOCATION_ID', None),
        ('LAST30DAYS_FACEBOOK_ROUTE_ID', None),
        ('LAST30DAYS_FACEBOOK_ROUTE_POOL_ENTRY_ID', None),
        ('LAST30DAYS_FACEBOOK_DISPLAY', None),
